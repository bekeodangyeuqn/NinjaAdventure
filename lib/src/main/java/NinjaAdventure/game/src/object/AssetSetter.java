...
import NinjaAdventure.game.src.entity.NPC_OldMan;
import NinjaAdventure.game.src.main.GamePanel;
import NinjaAdventure.game.src.monster.MON_Bat;
import NinjaAdventure.game.src.monster.MON_GreenSlime;
import NinjaAdventure.game.src.monster.MON_Orc;
import NinjaAdventure.game.src.monster.MON_RedSlime;
import NinjaAdventure.game.src.monster.MON_SkeletonLord;
import NinjaAdventure.game.src.object.OBJ_Key;
import NinjaAdventure.game.src.tile_interactive.IT_DestructibleWall;
